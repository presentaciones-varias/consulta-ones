...
DT::datatable(organigrama_destacado,
              ...
              escape = F,
              options = list(pageLength = 4, dom = "p"))
```

Unidades vinculadas a áreas de metodología e investigación
...
Polonia: muy descentralizado

Canadá: medianamente centralizado

México: muy centralizado
...
Científicos de datos, ingenieros de datos y expertos en visualización (habilidades escasas en el INE)
